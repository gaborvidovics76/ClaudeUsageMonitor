...
STRINGS: Dict[str, Dict[str, str]] = {
    # ---- panel ----
    "panel.five_hour": {
        "en": "5-HOUR SESSION", "hu": "5 ÓRÁS MUNKAMENET", "de": "5-STUNDEN-SITZUNG",
        "fr": "SESSION 5 HEURES", "es": "SESIÓN DE 5 HORAS", "it": "SESSIONE 5 ORE",
        "pt": "SESSÃO DE 5 HORAS", "pl": "SESJA 5-GODZINNA", "nl": "5-UURSSESSIE",
        "ru": "5-ЧАСОВОЙ СЕАНС", "cs": "5HODINOVÁ RELACE", "tr": "5 SAATLİK OTURUM",
    },
    "panel.weekly": {
        "en": "WEEKLY LIMIT", "hu": "HETI LIMIT", "de": "WÖCHENTLICHES LIMIT",
        "fr": "LIMITE HEBDOMADAIRE", "es": "LÍMITE SEMANAL", "it": "LIMITE SETTIMANALE",
        "pt": "LIMITE SEMANAL", "pl": "LIMIT TYGODNIOWY", "nl": "WEEKLIMIET",
        "ru": "ЕЖЕНЕДЕЛЬНЫЙ ЛИМИТ", "cs": "TÝDENNÍ LIMIT", "tr": "HAFTALIK LİMİT",
    },
    "panel.model": {
    ...
    "panel.reset": {
        "en": "reset {}", "hu": "reset {}", "de": "Reset {}", "fr": "réinit. {}",
        "es": "reinicio {}", "it": "ripristino {}", "pt": "redefinição {}", "pl": "reset {}",
        "nl": "reset {}", "ru": "сброс {}", "cs": "reset {}", "tr": "sıfırlanma {}",
    },
    "panel.per_hour": {
    ...
    "notify.reset_done": {
        "en": "{}: reset — a new period has started.", "hu": "{}: visszaállt — kezdődik az új időszak.",
        "de": "{}: zurückgesetzt — ein neuer Zeitraum hat begonnen.", "fr": "{} : réinitialisation — une nouvelle période commence.",
        "es": "{}: se ha reiniciado — comienza un nuevo período.", "it": "{}: ripristino completato — è iniziato un nuovo periodo.",
        "pt": "{}: redefinição concluída — começou um novo período.", "pl": "{}: reset — zaczął się nowy okres.",
        "nl": "{}: gereset — een nieuwe periode is begonnen.", "ru": "{}: сброс — начался новый период.",
        "cs": "{}: reset — začalo nové období.", "tr": "{}: sıfırlandı — yeni dönem başladı.",
    },
    "notify.stale_title": {
    ...
    "set.show_five_hour": {
        "en": "Show 5-hour session", "hu": "5 órás munkamenet mutatása", "de": "5-Stunden-Sitzung anzeigen",
        "fr": "Afficher la session de 5 heures", "es": "Mostrar sesión de 5 horas", "it": "Mostra sessione di 5 ore",
        "pt": "Mostrar sessão de 5 horas", "pl": "Pokaż sesję 5-godzinną", "nl": "5-uurssessie tonen",
        "ru": "Показывать 5-часовой сеанс", "cs": "Zobrazit 5hodinovou relaci", "tr": "5 saatlik oturumu göster",
    },
    "set.show_weekly": {
        "en": "Show weekly limit", "hu": "Heti limit mutatása", "de": "Wöchentliches Limit anzeigen",
        "fr": "Afficher la limite hebdomadaire", "es": "Mostrar límite semanal", "it": "Mostra limite settimanale",
        "pt": "Mostrar limite semanal", "pl": "Pokaż limit tygodniowy", "nl": "Weeklimiet tonen",
        "ru": "Показывать еженедельный лимит", "cs": "Zobrazit týdenní limit", "tr": "Haftalık limiti göster",
    },
    "set.show_model": {
        "en": "Show model weekly limit (claude.ai source)", "hu": "Modell heti limitjének mutatása (claude.ai forrás)",
        "de": "Wöchentliches Limit des Modells anzeigen (claude.ai-Quelle)", "fr": "Afficher la limite hebdomadaire du modèle (source claude.ai)",
        ...
        "nl": "Weeklimiet van model tonen (claude.ai-bron)", "ru": "Показывать еженедельный лимит модели (источник claude.ai)",
        "cs": "Zobrazit týdenní limit modelu (zdroj claude.ai)", "tr": "Model haftalık limitini göster (claude.ai kaynağı)",
    },
    "set.model_filter": {
    ...
    "set.show_reset": {
        ...
        "fr": "Compte à rebours avant réinitialisation", "es": "Cuenta atrás hasta el reinicio", "it": "Conto alla rovescia al ripristino",
        "pt": "Contagem decrescente até a redefinição", "pl": "Odliczanie do resetu", "nl": "Aftellen tot reset",
        "ru": "Обратный отсчёт до сброса", "cs": "Odpočet do resetu", "tr": "Sıfırlanmaya geri sayım",
    },
    "set.show_age": {
    ...
    "set.tray_five": {
        "en": "5-hour session", "hu": "5 órás munkamenet", "de": "5-Stunden-Sitzung", "fr": "Session de 5 heures",
        "es": "Sesión de 5 horas", "it": "Sessione di 5 ore", "pt": "Sessão de 5 horas", "pl": "Sesja 5-godzinna",
        "nl": "5-uurssessie", "ru": "5-часовой сеанс", "cs": "5hodinová relace", "tr": "5 saatlik oturum",
    },
    "set.tray_weekly": {
        "en": "Weekly limit", "hu": "Heti limit", "de": "Wöchentliches Limit", "fr": "Limite hebdomadaire",
        "es": "Límite semanal", "it": "Limite settimanale", "pt": "Limite semanal", "pl": "Limit tygodniowy",
        "nl": "Weeklimiet", "ru": "Еженедельный лимит", "cs": "Týdenní limit", "tr": "Haftalık limit",
    },
    "set.tray_max": {
    ...
    "set.notify_reset": {
        ...
        "de": "Benachrichtigen, wenn ein Limit zurückgesetzt wird", "fr": "Notifier quand une limite se réinitialise",
        "es": "Notificar cuando un límite se reinicia", "it": "Notifica quando un limite si ripristina",
        "pt": "Notificar quando um limite é redefinido", "pl": "Powiadamiaj o resecie limitu",
        "nl": "Melden wanneer een limiet wordt gereset", "ru": "Уведомлять при сбросе лимита",
        "cs": "Upozornit, když se limit resetuje", "tr": "Bir limit sıfırlanınca bildir",
    },
    "set.notify_stale": {
    ...
    "set.data_hint": {
        ...
        "fr": "Journal local : le plan-usage-history.json de Claude Desktop. Sans connexion, mais mesure seulement ce PC et se met à jour environ toutes les 5 minutes.\n\nclaude.ai : après connexion, interroge le serveur. Tu vois l'usage de tous tes appareils, avec des heures de réinitialisation exactes et une actualisation plus fréquente.",
        ...
        "it": "Log locale: il plan-usage-history.json di Claude Desktop. Nessun accesso, ma misura solo questo PC e si aggiorna ogni ~5 minuti.\n\nclaude.ai: dopo l'accesso interroga il server. Vedi l'uso di tutti i dispositivi, con orari di ripristino esatti e aggiornamento più frequente.",
        "pt": "Registo local: o plan-usage-history.json do Claude Desktop. Sem login, mas mede só este PC e atualiza a cada ~5 minutos.\n\nclaude.ai: após o login consulta o servidor. Vês o uso de todos os teus dispositivos, com horas de redefinição exatas e atualização mais frequente.",
    ...
    "hist.legend_5h": {
        "en": "5-hour session", "hu": "5 órás munkamenet", "de": "5-Stunden-Sitzung", "fr": "session de 5 h",
        "es": "sesión de 5 h", "it": "sessione di 5 ore", "pt": "sessão de 5 h", "pl": "sesja 5-godz.",
        "nl": "5-uurssessie", "ru": "5-часовой сеанс", "cs": "5hodinová relace", "tr": "5 saatlik oturum",
    },
    "hist.legend_week": {
        "en": "weekly limit", "hu": "heti limit", "de": "wöchentliches Limit", "fr": "limite hebdomadaire",
    ...
    "hist.stat_now": {
        ...
        "nl": "Huidig wekelijks", "ru": "Текущий еженедельный", "cs": "Aktuální týdenní", "tr": "Güncel haftalık",
    },
    "hist.stat_peak": {
    ...
    "hist.stat_sessions": {
        "en": "5-hour sessions", "hu": "5 órás munkamenetek", "de": "5-Stunden-Sitzungen", "fr": "Sessions de 5 h",
        "es": "Sesiones de 5 h", "it": "Sessioni di 5 ore", "pt": "Sessões de 5 h", "pl": "Sesje 5-godz.",
        "nl": "5-uurssessies", "ru": "5-часовые сеансы", "cs": "5hodinové relace", "tr": "5 saatlik oturumlar",
    },
    "hist.stat_forecast": {
        ...
        "ru": "Прогноз на конец недели", "cs": "Odhad na konec týdne", "tr": "Hafta bitimi tahmini",
    },
    "hist.no_data": {
