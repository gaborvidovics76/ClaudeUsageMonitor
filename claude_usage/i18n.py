...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "menu.login": {
        ...
        "sv": "Logga in (claude.ai, webbläsare)…",
    },
    "menu.history": {
    ...
    "notify.reset_done": {
        ...
        "sv": "{}: nollställt — ett nytt fönster har börjat.",
    },
    "notify.stale_title": {
    ...
    "notify.stale_body": {
        ...
        "sv": "Senaste avläsningen är {} gammal. Körs Claude Desktop?",
    },
    "notify.login_ok": {
        ...
        "sv": "Inloggad — serverdata är på väg.",
    },
    "notify.logout": {
        ...
        "sv": "Utloggad. Bytte till lokal källa.",
    },
    "notify.first_run": {
        ...
        "sv": "Panelen dök upp i det övre högra hörnet.\nHögerklicka på panelen eller ikonen i aktivitetsfältet = meny.",
    },
    "notify.autostart_on": {
        ...
        "sv": "Aktiverat: appen startar med Windows.",
    },
    "notify.autostart_off": {
        ...
        "sv": "Avaktiverat: appen startar inte med Windows.",
    },
    "notify.autostart_fail": {
        ...
        "sv": "Det gick inte att ställa in automatisk start.",
    },
    "err.no_tray": {
        ...
        "sv": "Aktivitetsfältet är inte tillgängligt; ikonen hoppas över.",
    },
    "err.already_running": {
        ...
        "sv": "Appen körs redan (titta i aktivitetsfältet).",
    },
    ...
    "dlg.intro": {
        ...
        "sv": "Logga in på ditt claude.ai-konto i din egen webbläsare (dina sparade lösenord och nycklar fungerar redan där).",
    },
    "dlg.step1": {
    ...
    "dlg.open_browser": {
        ...
        "sv": "Öppna inloggningen i webbläsaren",
    },
    "dlg.hint1": {
        ...
        "sv": "Logga in på sidan som öppnas och godkänn åtkomsten. Du får en kod på slutet.",
    },
    "dlg.step2": {
    ...
    "dlg.paste_label": {
        ...
        "sv": "Klistra in koden du fick här:",
    },
    ...
    "dlg.err_ratelimit": {
        ...
        "sv": "För många inloggningsförsök på kort tid.\n\nServern begränsar dig tillfälligt. Stäng det här fönstret, vänta 10–15 minuter (försök inte under tiden) och starta sedan EN ny inloggning i webbläsaren med en färsk kod.",
    },
    "dlg.err_badcode": {
        ...
        "sv": "Koden godtogs inte.\n\n{}\n\nKontrollera att du klistrade in hela koden, eller gör om inloggningen i webbläsaren (alltid med en färsk kod).",
    },
    "dlg.unknown_err": {
    ...
    "set.lock": {
        ...
        "sv": "Lås position (går inte att dra)",
    },
    "set.snap": {
    ...
    "set.taskbar": {
        ...
        "sv": "Visa i aktivitetsfältet (som ett fönster)",
    },
    "set.click_through": {
        ...
        "sv": "Klicka igenom (bara dekoration, ignorerar musen)",
    },
    "set.tip": {
        ...
        "sv": "Tips: dra panelen med vänster knapp, Ctrl+rulla ändrar storlek,\nhögerklick = meny, dubbelklick = historik.",
    },
    "set.show_five_hour": {
    ...
    "set.show_reset": {
        ...
        "sv": "Nedräkning till nollställning",
    },
    "set.show_age": {
    ...
    "set.tray_value": {
        ...
        "sv": "Värde på ikonen i aktivitetsfältet",
    },
    "set.tray_five": {
    ...
    "set.notify_enabled": {
        ...
        "sv": "Avisera när en gräns passeras",
    },
    "set.notify_reset": {
        ...
        "sv": "Avisera när en gräns nollställs",
    },
    "set.notify_stale": {
        ...
        "sv": "Avisera när data blir inaktuella",
    },
    "set.color_hint": {
        ...
        "sv": "Färgerna följer gränsvärdena: grönt → gult → rött.",
    },
    "set.source_label": {
    ...
    "set.source_local": {
        ...
        "sv": "Lokal logg – bara den här datorn",
    },
    "set.source_api": {
        ...
        "sv": "claude.ai – alla enheter (kräver inloggning)",
    },
    "set.login_btn_in": {
    ...
    "set.data_hint": {
        ...
        "sv": "Lokal logg: Claude Desktops plan-usage-history.json. Ingen inloggning, men mäter bara den här datorn och uppdateras ungefär var femte minut.\n\nclaude.ai: efter inloggning frågas servern. Du ser användningen från alla dina enheter, med exakta nollställningstider och tätare uppdatering.",
    },
    "set.pick_file_title": {
    ...
    "set.about": {
        ...
        "sv": "{}\nArbetar med lokala data, skickar ingenting någonstans.",
    },
    "set.reset_confirm": {
        ...
        "sv": "Vill du verkligen återställa standardinställningarna?",
    },
    ...
    "hist.no_data": {
        ...
        "sv": "Inte tillräckligt med data för den här perioden.",
    },
