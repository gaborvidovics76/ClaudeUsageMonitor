...
STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "notify.stale_body": {
        ...
        "ja": "最後の取得から{}経過しています。Claude Desktopは実行中ですか？",
    },
    "notify.login_ok": {
    ...
    "err.no_tray": {
        ...
        "ja": "システムトレイを利用できないため、トレイアイコンをスキップします。",
    },
    "err.already_running": {
    ...
    "dlg.intro": {
        ...
        "ja": "お使いのブラウザーでclaude.aiアカウントにサインインしてください (保存済みのパスワードやパスキーがそのまま使えます)。",
    },
    "dlg.step1": {
    ...
    "dlg.hint1": {
        ...
        "ja": "開いたページでサインインし、アクセスを許可してください。最後にコードが表示されます。",
    },
    "dlg.step2": {
    ...
    "dlg.err_ratelimit": {
        ...
        "ja": "短時間にサインインを試行しすぎました。\n\nサーバーが一時的に制限をかけています。このウィンドウを閉じて10〜15分待ち (その間は試さないでください)、新しいコードでブラウザーからのサインインを1回だけやり直してください。",
    },
    "dlg.err_badcode": {
        ...
        "ja": "コードが受け付けられませんでした。\n\n{}\n\nコード全体を貼り付けたか確認するか、ブラウザーからのサインインをやり直してください (必ず新しいコードで)。",
    },
    "dlg.unknown_err": {
    ...
    "set.tip": {
        ...
        "ja": "ヒント: 左ボタンでパネルをドラッグ、Ctrl+ホイールでサイズ変更、\n右クリック = メニュー、ダブルクリック = 履歴。",
    },
    "set.show_five_hour": {
    ...
    "set.data_hint": {
        ...
        "ja": "ローカルログ: Claude Desktopのplan-usage-history.jsonを読み取ります。サインインは不要ですが、計測対象はこのPCのみで、更新はおよそ5分ごとです。\n\nclaude.ai: サインイン後にサーバーへ問い合わせます。全デバイスの使用量を、正確なリセット時刻とより高い更新頻度で確認できます。",
    },
    "set.pick_file_title": {
